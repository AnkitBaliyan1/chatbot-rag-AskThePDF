...
def push_to_pinecone(docs, embedding,namespace):
    ...
    if os.environ.get("PINECONE_NAMESPACE", "logolabs") in namespace_list:
        index.delete(delete_all=True, namespace=os.environ.get("PINECONE_NAMESPACE", "logolabs"))
    else:
        pass
    ...
    try:
        ...
        index = Pinecone.from_documents(docs, embedding, index_name = index_name, namespace=os.environ.get("PINECONE_NAMESPACE", "logolabs"))
...
def pull_from_pinecone(embeddings):
    ...
    index = Pinecone.from_existing_index(pinecone_index_name, embeddings, namespace=os.environ.get("PINECONE_NAMESPACE", "logolabs"))
